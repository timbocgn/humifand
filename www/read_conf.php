<?php
    ...
    // --- this is the server side of the AJAX config pages. It is simply an interface to the config files (read part)
    ...
    $myfile = fopen($confFile, "r") or die("Unable to open config file!");
